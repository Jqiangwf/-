//
//  JQResultCollectionViewController.m
//  demo_searchAfter8
//
...
@interface JQResultCollectionViewController ()

@end

@implementation JQResultCollectionViewController
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    //cell时复用的，要想在此方法中给cell添加视图，必须判断
    ...
    lb.text = _results[indexPath.item];
    return cell;
}
- (NSArray *)results{
    if (!_results) {
